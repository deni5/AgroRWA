...
cat > apps/web/src/app/portfolio/page.tsx << 'EOF'
'use client'
              ...
              <div key={asset.address} style={{ background: '#f4faf6', borderRadius: '16px', padding: '16px 20px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '16px' }}>
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '6px' }}>
                    ...
                    <span style={{ padding: '2px 8px', borderRadius: '20px', fontSize: '10px', fontWeight: '700', textTransform: 'uppercase' as const, background: LIFECYCLE_COLOR[asset.lifecycleStatus] + '22', color: LIFECYCLE_COLOR[asset.lifecycleStatus], border: `1px solid ${LIFECYCLE_COLOR[asset.lifecycleStatus]}44` }}>{asset.lifecycleStatus}</span>
                  ...
                  <div style={{ display: 'flex', gap: '16px', fontSize: '13px', color: '#7aaa88' }}>
                    ...
                    <span>{(Number(asset.pricePerUnit) / 1_000_000).toFixed(2)} USDC/{asset.unit}</span>
